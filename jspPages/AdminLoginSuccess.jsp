...
<p>You have successfully logged in using username: <%=sesh.getAttribute("username")%></p>
	<form method="post" action="Logout.jsp">
		...
		<table>
			<tr>
				<td><input id ="usr1" type="submit" value="Browse Listings"></td>
			</tr>
		</table>
	</form>
	...
	<form method="post" action="ViewAcct.jsp">
		...
		<table>
			<tr>
				<td><input id ="usr2" type="submit" value="Edit Account"></td>
			</tr>
		</table>
	</form>
		...
		<table>
			<tr>
				<td><input id="adm1"  type="submit" value="Add Customer Rep."></td>
			</tr>
		</table>
	</form>
		...
		<table>
			<tr>
				<td><input  id="adm2" type="submit" value="Edit another Account"></td>
			</tr>
		</table>
	</form>
	<form method="post" action="createReport.jsp">
 			<select name="CreateReport">
 				<option selected disabled>-Select Report type-</option>
 				<option value="totalEarnings">Total Earnings</option>
 				<option value="earningsPerItem">Earnings Per Vehicle</option>
 				<option value="earningsPerClass">Earnings Per Vehicle Class</option>
 				<option value="earningsPerUser">Earnings Per User</option>
				<option value="bestSellingItems">Best Selling Vehicles</option>
