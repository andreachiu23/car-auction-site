...
if(endbid == -1 && current != 0)//If bid is over and there is a current bid
{
...
if(endbid == -1 && current == 0)//If bid is over and noone has won
{
...
<table>
	<tr>
		<td>
			<form method="post" action="displayListingSuper.jsp"> 
